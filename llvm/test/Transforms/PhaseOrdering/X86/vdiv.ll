...
; CHECK-NEXT:    [[TMP1:%.*]] = getelementptr inbounds double, double* [[Y]], i64 [[INDEX]]
; CHECK-NEXT:    [[TMP2:%.*]] = bitcast double* [[TMP1]] to <4 x double>*
; CHECK-NEXT:    [[WIDE_LOAD:%.*]] = load <4 x double>, <4 x double>* [[TMP2]], align 8, !tbaa [[TBAA3:![0-9]+]], !alias.scope !7
; CHECK-NEXT:    [[TMP3:%.*]] = fmul fast <4 x double> [[WIDE_LOAD]], [[TMP0]]
; CHECK-NEXT:    [[TMP4:%.*]] = getelementptr inbounds double, double* [[X]], i64 [[INDEX]]
; CHECK-NEXT:    [[TMP5:%.*]] = bitcast double* [[TMP4]] to <4 x double>*
; CHECK-NEXT:    store <4 x double> [[TMP3]], <4 x double>* [[TMP5]], align 8, !tbaa [[TBAA3]], !alias.scope !10, !noalias !7
...
; CHECK-NEXT:    [[TMP7:%.*]] = xor i64 [[BC_RESUME_VAL]], -1
; CHECK-NEXT:    [[TMP8:%.*]] = add nsw i64 [[TMP7]], [[WIDE_TRIP_COUNT]]
...
; CHECK-NEXT:    [[TMP9:%.*]] = fdiv fast double 1.000000e+00, [[A]]
; CHECK-NEXT:    br label [[FOR_BODY_PROL:%.*]]
; CHECK:       for.body.prol:
; CHECK-NEXT:    [[INDVARS_IV_PROL:%.*]] = phi i64 [ [[INDVARS_IV_NEXT_PROL:%.*]], [[FOR_BODY_PROL]] ], [ [[BC_RESUME_VAL]], [[FOR_BODY_PROL_PREHEADER]] ]
...
; CHECK-NEXT:    [[TMP10:%.*]] = fmul fast double [[T0_PROL]], [[TMP9]]
; CHECK-NEXT:    [[ARRAYIDX2_PROL:%.*]] = getelementptr inbounds double, double* [[X]], i64 [[INDVARS_IV_PROL]]
; CHECK-NEXT:    store double [[TMP10]], double* [[ARRAYIDX2_PROL]], align 8, !tbaa [[TBAA3]]
...
; CHECK-NEXT:    [[INDVARS_IV_UNR:%.*]] = phi i64 [ [[BC_RESUME_VAL]], [[SCALAR_PH]] ], [ [[INDVARS_IV_NEXT_PROL]], [[FOR_BODY_PROL]] ]
; CHECK-NEXT:    [[TMP11:%.*]] = icmp ult i64 [[TMP8]], 3
; CHECK-NEXT:    br i1 [[TMP11]], label [[FOR_END]], label [[FOR_BODY_PREHEADER8:%.*]]
; CHECK:       for.body.preheader8:
; CHECK-NEXT:    [[TMP12:%.*]] = fdiv fast double 1.000000e+00, [[A]]
; CHECK-NEXT:    [[TMP13:%.*]] = fdiv fast double 1.000000e+00, [[A]]
; CHECK-NEXT:    [[TMP14:%.*]] = fdiv fast double 1.000000e+00, [[A]]
; CHECK-NEXT:    [[TMP15:%.*]] = fdiv fast double 1.000000e+00, [[A]]
; CHECK-NEXT:    br label [[FOR_BODY:%.*]]
; CHECK:       for.body:
; CHECK-NEXT:    [[INDVARS_IV:%.*]] = phi i64 [ [[INDVARS_IV_NEXT_3:%.*]], [[FOR_BODY]] ], [ [[INDVARS_IV_UNR]], [[FOR_BODY_PREHEADER8]] ]
...
; CHECK-NEXT:    [[TMP16:%.*]] = fmul fast double [[T0]], [[TMP12]]
; CHECK-NEXT:    [[ARRAYIDX2:%.*]] = getelementptr inbounds double, double* [[X]], i64 [[INDVARS_IV]]
; CHECK-NEXT:    store double [[TMP16]], double* [[ARRAYIDX2]], align 8, !tbaa [[TBAA3]]
...
; CHECK-NEXT:    [[TMP17:%.*]] = fmul fast double [[T0_1]], [[TMP13]]
; CHECK-NEXT:    [[ARRAYIDX2_1:%.*]] = getelementptr inbounds double, double* [[X]], i64 [[INDVARS_IV_NEXT]]
; CHECK-NEXT:    store double [[TMP17]], double* [[ARRAYIDX2_1]], align 8, !tbaa [[TBAA3]]
...
; CHECK-NEXT:    [[TMP18:%.*]] = fmul fast double [[T0_2]], [[TMP14]]
; CHECK-NEXT:    [[ARRAYIDX2_2:%.*]] = getelementptr inbounds double, double* [[X]], i64 [[INDVARS_IV_NEXT_1]]
; CHECK-NEXT:    store double [[TMP18]], double* [[ARRAYIDX2_2]], align 8, !tbaa [[TBAA3]]
...
; CHECK-NEXT:    [[TMP19:%.*]] = fmul fast double [[T0_3]], [[TMP15]]
; CHECK-NEXT:    [[ARRAYIDX2_3:%.*]] = getelementptr inbounds double, double* [[X]], i64 [[INDVARS_IV_NEXT_2]]
; CHECK-NEXT:    store double [[TMP19]], double* [[ARRAYIDX2_3]], align 8, !tbaa [[TBAA3]]
